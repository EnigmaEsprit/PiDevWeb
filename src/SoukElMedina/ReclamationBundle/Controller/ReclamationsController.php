...
class ReclamationsController extends Controller
{
    ...
    public function archiveReclamationsAction($id)
    {
        // ...
        $this->denyAccessUnlessGranted("IS_AUTHENTICATED_FULLY");
        $em = $this->getDoctrine()->getManager();
        $archiver      = $this->get('cl_archiver.archiver.entity');
        $order         = $em->getRepository('SoukElMedinaPidevBundle:Reclamations')->find($id);
        $archivedOrder = $archiver->archive($order);
        // ...
    }

    public function unArchiveReclamationsAction($id)
    {
        // ...
        $this->denyAccessUnlessGranted("IS_AUTHENTICATED_FULLY");
        $em = $this->getDoctrine()->getManager();
        $archiver      = $this->get('cl_archiver.archiver.entity');
        $archivedOrder = $em->getRepository('SoukElMedinaPidevBundle:ArchivedReclamations')->find($id);
