...
class EvenementsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('evenements/panier.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SoukElMedina\PidevBundle\Form\EvenementsType', $evenement);
    ...
    {
        $deleteForm = $this->createDeleteForm($evenement);
        $editForm = $this->createForm('SoukElMedina\PidevBundle\Form\EvenementsType', $evenement);
